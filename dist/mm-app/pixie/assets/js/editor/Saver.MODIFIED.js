...
.factory('saver', ['$rootScope', '$mdDialog', '$http', '$timeout', 'canvas', function($rootScope, $mdDialog, $http, $timeout, canvas) {
	...
	var saver = {
        ...
        saveImage: function(format, quality, name, e, type) {
            ...
            this.saveToComputer(format, quality, name, type);
        },
        ...
        saveToComputer: function(format, quality, name, type) { 
            //canvas.zoom(1);

            var link = document.createElement('a'),
                data = this.getDataUrl(format, quality);

            this.handleCallbacks(data, name, type);
        ...
        handleCallbacks: function(data, name, type) {
            ...
            if ($rootScope.getParam('onSave')) {
                ...
                $rootScope.getParam('onSave')(data, img, name, type);
            }
        },
